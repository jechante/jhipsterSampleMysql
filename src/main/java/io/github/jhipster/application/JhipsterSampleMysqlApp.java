...
public class JhipsterSampleMysqlApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleMysqlApp.class);

    private final Environment env;

    public JhipsterSampleMysqlApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleMysql.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleMysqlApp.class);
